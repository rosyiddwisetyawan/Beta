...
public class TerbaruUtamaAdapter extends RecyclerView.Adapter<TerbaruUtamaAdapter.ViewHolder> {

    private Context context;
    private List<Politik> list;

    public TerbaruUtamaAdapter(Context context, List<Politik> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_listitem_top, parent, false);
...
//                .into(holder.image);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            parentLayout = itemView.findViewById(R.id.parent_layout_politik_top);
        }
    }
